...
{
    int x;
// g_keyState is updated already ... via KeyboardCommands call to SDL_GetKeyState();
...
UpdateGamepad(void)
{
    ...
    // FCEU_UpdateInput  checks bitmask and if GAME_PAD is set jumps here.
...
#ifdef __QNXNTO__
    fprintf(stderr,"InitInputInterface\n");
#else
#error QNXNTO not defined.
#endif
